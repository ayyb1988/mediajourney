...
final class StorageUtils {
    ...
    private static final String TAG = "CacheLog-StorageUtils";
     ...
     * created on SD card <i>("/Android/data/[app_package_name]/cache/media-cache")</i> if card is mounted .
    ...
    private static File getCacheDirectory(Context context, boolean preferExternal) {
        ...
        if (appCacheDir == null) {
            ...
            if (CacheLog.DEBUG) {
                CacheLog.w(TAG, "getCacheDirectory: Can't define system cache directory! '" + cacheDirPath + "%s' will be used.");
            }
    ...
    private static File getExternalCacheDir(Context context) {
        ...
        if (!appCacheDir.exists()) {
            if (!appCacheDir.mkdirs()) {
                if (CacheLog.DEBUG) {
                    CacheLog.w(TAG, "Unable to create external cache directory");
                }
                return null;
            }
        }
