...
public abstract class LruDiskUsage implements DiskUsage {
    ...
    private static final String TAG = "CacheLog-LruDiskUsage";
        ...
        for (File file : files) {
            ...
            if (!accepted) {
                ...
                if (deleted) {
                    ...
                    totalSize -= fileSize;
                    if (CacheLog.DEBUG) {
                        CacheLog.i(TAG, "Cache file " + file + " is deleted because it exceeds cache limit");
                    }
                } else {
                    if (CacheLog.DEBUG) {
                        CacheLog.e("Error deleting file " + file + " for trimming cache");
                    }
                }
            }
        }
